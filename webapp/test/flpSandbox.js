		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zfinishinspection-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zfinishinspection-display": {
								"semanticObject": "zfinishinspection",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zfinishinspection",
									"url": sap.ui.require.toUrl("zfinishinspection")
								}
							}
						}
					}
